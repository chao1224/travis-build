...
View valid versions of \"mono\" at https://docs.travis-ci.com/user/languages/csharp/"
          ...
          sh.fold('mono-install') do
            ...
            when 'osx'
              sh.cmd "curl --retry 5 -o \"/tmp/mdk.pkg\" -fL #{mono_osx_url}", timing: true, assert: true, echo: true
            ...
            if is_mono_before_3_12 && config[:os] == 'linux'
              ...
              sh.cmd 'curl --retry 5  -fL -o /tmp/certdata.txt https://hg.mozilla.org/releases/mozilla-release/raw-file/5d447d9abfdf/security/nss/lib/ckfw/builtins/certdata.txt'
...
View valid versions of \"dotnet\" at https://docs.travis-ci.com/user/languages/csharp/"
          ...
          sh.fold('dotnet-install') do
            ...
            when 'osx'
              ...
              sh.cmd "curl --retry 5 -o \"/tmp/dotnet.pkg\" -fL #{dotnet_osx_url}", timing: true, assert: true, echo: true
